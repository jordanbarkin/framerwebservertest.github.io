exports.StatusBar = class iOSStatusBar extends Layer
	...
	constructor: (@options) ->
		...
		@statusLeft   = new Layer superLayer: @, image: imgLeft,   width: 130/2, height: HEIGHT
		@statusMiddle = new Layer superLayer: @, image: imgMiddle, width: 108/2, height: HEIGHT, x: (WIDTH/2-108/2)/2
		@statusRight  = new Layer superLayer: @, image: imgRight,  width: 130/2, height: HEIGHT, x: (WIDTH-130)/2
